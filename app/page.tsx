...
export default function Home() {
  return (
    <div className="animate-in fade-in flex min-h-svh max-h-svh w-full flex-col overflow-hidden px-1 py-1 duration-700 md:justify-center">
      {/* Hero Text */}
      <div className="mt-6 mb-3 flex flex-col items-center md:mt-10 md:mb-6 md:gap-2">
        <Badge
          variant="outline"
        ...
        <h1 className="bg-text-gradient-uic bg-clip-text px-5 pt-0 pb-0 text-center text-3xl font-black text-transparent text-shadow-[0px_0px_0px_20px_var(--inset-color)] md:text-5xl">
