...
function CommentsPane({comments, parsedSlug} : testProps) {
    ...
    return (
        <div className="w-full h-full flex flex-col">
            ...
            <div className="flex flex-col w-full p-8 overflow-y-scroll gap-3">
                ...
                {/* Version with profile pic */}
                {/* <Card className = "flex flex-row border-foreground/20 rounded-md gap-5 px-5 items-center">
                        <h5 className="flex items-center justify-center rounded-full bg-uic-red-300 w-10 h-10 aspect-square text-foreground">AT</h5>
                        <CardDescription>Boring but informative—like reading the manual, then actually using it. Learned stuff, didn’t love the vibes.</CardDescription>
                </Card> */}

            </div>

            <div className='p-4'>
                <InputGroup className="overflow-y rounded-sm border-2 border-uic-navy-800/10 focus-visible:ring-0 bg-background">
